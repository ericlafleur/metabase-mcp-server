import { z } from "zod";
export function addTableTools(server, metabaseClient) {
    /**
    ...
    server.addTool({
        ...
        execute: async (args) => {
            try {
                ...
                throw new Error(`Failed to bulk update tables: ${error instanceof Error ? error.message : "Unknown error"}`);
            }
        },
    });
    /**
    ...
    server.addTool({
        ...
        execute: async (args) => {
            try {
                ...
                throw new Error(`Failed to get table ${args.table_id}: ${error instanceof Error ? error.message : "Unknown error"}`);
            }
        },
    });
    /**
    ...
    server.addTool({
        ...
        execute: async (args) => {
            try {
                const result = await metabaseClient.updateTable(args.table_id, args.updates);
                return JSON.stringify(result, null, 2);
            }
            catch (error) {
                throw new Error(`Failed to update table ${args.table_id}: ${error instanceof Error ? error.message : "Unknown error"}`);
            }
        },
    });
    /**
    ...
    server.addTool({
        ...
        execute: async (args) => {
            try {
                ...
                throw new Error(`Failed to get FKs for table ${args.table_id}: ${error instanceof Error ? error.message : "Unknown error"}`);
            }
        },
    });
    /**
    ...
    server.addTool({
        ...
        execute: async (args) => {
            try {
                const result = await metabaseClient.getTableQueryMetadata(args.table_id, {
                    include_sensitive_fields: args.include_sensitive_fields,
                    include_hidden_fields: args.include_hidden_fields,
                    include_editable_data_model: args.include_editable_data_model,
                });
                ...
                throw new Error(`Failed to get query metadata for table ${args.table_id}: ${error instanceof Error ? error.message : "Unknown error"}`);
            }
        },
    });
    /**
    ...
    server.addTool({
        ...
        execute: async (args) => {
            try {
                ...
                throw new Error(`Failed to get related entities for table ${args.table_id}: ${error instanceof Error ? error.message : "Unknown error"}`);
            }
        },
    });
    /**
    ...
    server.addTool({
        ...
        execute: async (args) => {
            try {
                ...
                throw new Error(`Failed to get FKs for card table card__${args.card_id}: ${error instanceof Error ? error.message : "Unknown error"}`);
            }
        },
    });
    /**
    ...
    server.addTool({
        ...
        execute: async (args) => {
            try {
                const result = await metabaseClient.getCardTableQueryMetadata(args.card_id);
                return JSON.stringify(result, null, 2);
            }
            catch (error) {
                throw new Error(`Failed to get query metadata for card table card__${args.card_id}: ${error instanceof Error ? error.message : "Unknown error"}`);
            }
        },
    });
    /**
    ...
    server.addTool({
        ...
        execute: async (args) => {
            try {
                const result = await metabaseClient.appendCsvToTable(args.table_id, args.filename, args.file_content);
                return JSON.stringify(result, null, 2);
            }
            catch (error) {
                throw new Error(`Failed to append CSV to table ${args.table_id}: ${error instanceof Error ? error.message : "Unknown error"}`);
            }
        },
    });
    /**
    ...
    server.addTool({
        ...
        execute: async (args) => {
            try {
                const result = await metabaseClient.discardTableFieldValues(args.table_id);
                return JSON.stringify(result, null, 2);
            }
            catch (error) {
                throw new Error(`Failed to discard values for table ${args.table_id}: ${error instanceof Error ? error.message : "Unknown error"}`);
            }
        },
    });
    /**
    ...
    server.addTool({
        ...
        execute: async (args) => {
            try {
                const result = await metabaseClient.reorderTableFields(args.table_id, args.field_order);
                return JSON.stringify(result, null, 2);
            }
            catch (error) {
                throw new Error(`Failed to reorder fields for table ${args.table_id}: ${error instanceof Error ? error.message : "Unknown error"}`);
            }
        },
    });
    /**
    ...
    server.addTool({
        ...
        execute: async (args) => {
            try {
                const result = await metabaseClient.replaceTableCsv(args.table_id, args.csv_file);
                return JSON.stringify(result, null, 2);
            }
            catch (error) {
                throw new Error(`Failed to replace CSV for table ${args.table_id}: ${error instanceof Error ? error.message : "Unknown error"}`);
            }
        },
    });
    /**
    ...
    server.addTool({
        ...
        execute: async (args) => {
            try {
                const result = await metabaseClient.rescanTableFieldValues(args.table_id);
                return JSON.stringify(result, null, 2);
            }
            catch (error) {
                throw new Error(`Failed to rescan values for table ${args.table_id}: ${error instanceof Error ? error.message : "Unknown error"}`);
            }
        },
    });
    /**
    ...
    server.addTool({
        ...
        execute: async (args) => {
            try {
                ...
                return JSON.stringify({ table_id: args.table_id, status: "schema_sync_triggered", result }, null, 2);
            }
            catch (error) {
                throw new Error(`Failed to sync schema for table ${args.table_id}: ${error instanceof Error ? error.message : "Unknown error"}`);
            }
        },
    });
    /**
    ...
    server.addTool({
        ...
        execute: async (args) => {
            try {
                const result = await metabaseClient.getTableData(args.table_id, args.limit);
                return JSON.stringify(result, null, 2);
            }
            catch (error) {
                throw new Error(`Failed to fetch data for table ${args.table_id}: ${error instanceof Error ? error.message : "Unknown error"}`);
            }
        },
    });
}
